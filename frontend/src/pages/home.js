      ...
      <div class="container">
        ...
        <NavLink to="/team" title="View Team Members">
					<div class="dashboardcard">
						<h2>2 <span><i class="fa fa-eye" aria-hidden="true"></i></span></h2>
        ...
        <NavLink to="/applications" title="View Appllications">
					<div class="dashboardcard">
						<h2>12 <span><i class="fa fa-eye" aria-hidden="true"></i></span></h2>
        ...
        <NavLink to="/contact" title="View Contacts">
					<div class="dashboardcard">
						<h2>3 <span><i class="fa fa-eye" aria-hidden="true"></i></span></h2>
